...
const projects: Project[] = [
  {
    ...
    title: "ArthaPOS — Scalable Retail Ops",
    tagline: "Sistem kasir cloud-native untuk optimasi profit margins.",
    goal: "Menggantikan sistem legacy yang lambat dan sering terjadi selisih stok di jaringan UMKM.",
    outcome: "Migrasi sukses ke 15+ outlet dengan peningkatan akurasi inventaris hingga 99.8%.",
    features: [
      "Real-time Inventory & Stock Tracking",
      "Point of Sale dengan integrasi QRIS",
      "Laporan analytics margin & performa sales",
    ],
    techs: ["Laravel", "React", "PostgreSQL"],
    youtubeId: "",
    githubUrl: "#",
    demoUrl: "#",
    status: "completed",
  ...
  {
    category: "E-Commerce",
    title: "BloomSync — Omnichannel Commerce",
    tagline: "High-conversion platform untuk industri florist premium.",
    goal: "Otomatisasi pemesanan multi-channel (Web, WA, IG) dalam satu dashboard terpusat.",
    outcome: "Meningkatkan efisiensi admin hingga 60% dan menangani ribuan order saat peak season.",
    features: [
      "Custom checkout with Midtrans integration",
      "WhatsApp automated booking confirmation",
      "Inventory sync across multiple platforms",
    ],
    techs: ["Next.js", "Laravel", "Tailwind"],
    youtubeId: "",
    githubUrl: "#",
    demoUrl: "#",
    status: "completed",
  },
  {
    ...
    title: "FinFlow — Personal Wealth Engine",
    tagline: "Predictive finance management untuk high-net-worth users.",
    goal: "Memberikan visibilitas penuh pada cashflow melalui visualisasi data yang 'opinionated'.",
    outcome: "Mendapatkan rating 4.8/5 di beta-testing dengan fokus pada simplisitas UX.",
    features: [
      "Automated expense categorization via AI",
      "Visual wealth tracking & goal planning",
      "Secure data encryption & cloud sync",
    ],
  ...
  },
  {
    ...
    title: "NexusOS — Team Productivity Hub",
    tagline: "Sistem operasi kolaborasi untuk tim remote modern.",
    goal: "Mengurangi noise komunikasi tim dengan menggabungkan tugas & dokumen di satu tempat.",
    outcome: "Prototype berhasil memangkas delivery time sprint tim internal hingga 22%.",
    features: [
      "Real-time collaborative document editing",
      "Sprint planning & kanban metrics",
      "Integrasi notifikasi Slack & Email",
    ],
